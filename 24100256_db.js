    ...
    if(!error)
    {
        ...
        connectionString.query(`CREATE DATABASE IF NOT EXISTS ${process.env.database}`, async (err2,result) =>
        {
            ...
            else
            {
                ...
                */
               table_query_1= 'CREATE TABLE LMS.Students (student_id int NOT NULL AUTO_INCREMENT, name Varchar(100) NOT NULL,  campus_id int NOT NULL UNIQUE, password Varchar(255) NOT NULL, contact_number Varchar(100) NOT NULL, total_fine_due int   , PRIMARY KEY(student_id));'
               createTable(table_query_1)
                
                table_query_2='CREATE TABLE LMS.Books (book_id int NOT NULL  AUTO_INCREMENT,title varchar(500) NOT NULL,released_date varchar(255) DEFAULT NULL,edition varchar(50) DEFAULT NULL,author varchar(100) NOT NULL,cost int DEFAULT NULL,PRIMARY KEY (book_id));'
                createTable(table_query_2)

                table_query_3= 'CREATE TABLE LMS.Staff (staff_id int NOT NULL AUTO_INCREMENT, name Varchar(100) NOT NULL, password Varchar(255) NOT NULL, contact_number int NOT NULL, PRIMARY KEY (staff_id));'
